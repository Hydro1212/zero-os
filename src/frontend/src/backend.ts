...
export class Backend implements backendInterface {
    ...
    async addApp(arg0: App): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addApp(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async deleteApp(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getApps(): Promise<Array<App>> {
        if (this.processError) {
            try {
                const result = await this.actor.getApps();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateApp(arg0: App): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateApp(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
